...
export const WEDDING_DETAILS = {
  ...
  ceremony: {
    ...
    venue: 'St Francis de Sales Parish Catholic Church Katani',
  ...
  contacts: [
    { name: 'Carole RSVP', phone: '+254 724 783 311' },
...
export const PROGRAM_ITEMS: ProgramItem[] = [
  {
    ...
    description: 'Sacrament of Holy Matrimony and Nuptial Mass at St Francis de Sales Parish Catholic Church Katani.',
