...
export default function AdminPanel() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (passcode === 'caroljohn2026' || passcode === 'carolejohn2026' || passcode === '2026') {
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute('download', `carole_and_john_wedding_rsvps_${new Date().toISOString().slice(0,10)}.csv`);
    ...
    <>
      ...
      <div className="py-10 bg-maroon-900 flex justify-center border-t border-maroon-950 text-stone-100 font-sans text-xs select-none">
        <div className="flex flex-col items-center gap-2">
          <p className="text-stone-300">© 2026 Carole &amp; John. All rights reserved.</p>
          <button
              ...
              <div className="border-b border-stone-100 p-6 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-stone-500 font-sans">Carole &amp; John Wedding RSVP Dashboard</p>
                  </div>
                </div>
                <button
              ...
              {!isAuthenticated ? (
                <div className="p-12 flex flex-col items-center justify-center text-center max-w-sm mx-auto space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-stone-500">Exclusively for Carole & John to access the guest RSVP database.</p>
                  </div>
