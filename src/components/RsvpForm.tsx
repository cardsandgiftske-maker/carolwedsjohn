      ...
      <section className="relative py-24 bg-[#FAF7F2] text-stone-850 border-t border-stone-200/60" id="rsvp-section">
        ...
        <div className="container mx-auto px-4 max-w-4xl relative z-10">
          ...
          <div className="text-center mb-16">
            <span className="text-emerald-700 text-xs font-semibold tracking-widest uppercase font-sans">Confirm Attendance</span>
            <h2 className="text-3xl md:text-5xl font-display font-light text-stone-900 mt-2 mb-4">RSVP &amp; E-Invitation</h2>
            ...
            <p className="text-stone-600 text-sm md:text-base mt-4 max-w-xl mx-auto italic font-serif">
              Please respond by August 10th, 2026, to help us finalize catering, seating plans, and personalize your digital entry card.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
            ...
            <div className="md:col-span-6 bg-white border border-stone-200/60 p-8 rounded-2xl shadow-md">
              ...
              <form onSubmit={handleRsvpSubmit} className="space-y-5" id="rsvp-wedding-form">
                ...
                {/* Additional details depending on willAttend */}
                <AnimatePresence>
                  {willAttend === 'yes' && (
                    <motion.div
                        ...
                        <div className="flex items-center gap-2">
                          {[1, 2, 3, 4].map((num) => (
                            <button
                              ...
                              className={`w-11 h-11 rounded-lg border text-sm font-semibold transition-all cursor-pointer ${
                                adultsCount === num
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    placeholder="Optional message (e.g., Congratulations Carol & John!, or vegetarian meal request)"
                    value={notes}
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center text-center space-y-4">
                      ...
                      <div className="space-y-0.5">
                        ...
                        <h5 className="font-serif text-xl font-light text-stone-900">Carol &amp; John</h5>
                      </div>
                        ...
                        <div className="flex items-center justify-center gap-2 pt-1 border-t border-stone-100">
                          ...
                          {submittedGuest.willAttend === 'yes' && (
                            <span className="text-[10px] text-stone-500 font-sans">
                              (Seats: {submittedGuest.adultsCount})
                            </span>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="text-[10px] text-stone-500 text-center space-y-0.5 leading-relaxed font-sans">
                        ...
                        <p className="italic text-stone-500">SFS Catholic Church, Katani &amp; Brighton Intl School</p>
                      </div>
